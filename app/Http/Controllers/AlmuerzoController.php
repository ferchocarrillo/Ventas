...
use App\JhonatanPermission\Models\Almuerzo;
use App\Http\Controllers\Timestamp;
use DateTime;
use CreateAlmuerzosTable;
...

{
    ...
    /*$formattedweddingdate = $myDateTime->format('d-m-Y');*/
        ...
        $Almuerzo->fecha = date('Y-m-d');
        $Almuerzo->almuerzo = date('H:i:s');
        $Almuerzo->usuario = $user_id.','.$user_nombre;
