...
<form name="f1" action="{{ url('/portadigital/'.$portadigitals->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
   ...
   <div class="form-group col-md-6">
        ...
        placeholder="Numero"
        name="numero"
        value="{{ old('numero', $portadigitals->numero)}}">
   </div>
  ...
  <div class="form-group col-md-6">
    <label for="documento">Documento</label>
       ...
       name="documento"
       value="{{ old('documento' , $portadigitals->documento)}}">
  ...
  <div class="form-group col-md-6">
    <label for="nombres">Nombres</label>
       ...
       placeholder="Nombres"
       name="nombres"
       value="{{ old('nombres' , $portadigitals->nombres)}}">
  ...
  <div class="form-group col-md-6">
    <label for="apellidos">Apellidos</label>
       ...
       name="apellidos"
       value="{{ old('apellidos' , $portadigitals->apellidos)}}">
  ...
  <div class="form-group col-md-6">
    <label for="correo">Correo</label>
       ...
       placeholder="Correo"
       name="correo"
       value="{{ old('correo' , $portadigitals->correo)}}">
  </div>
  ...
  <div class="form-group col-md-6">
    <label for="departamento">Departamento</label>
       ...
       name="departamento"
       value="{{ old('departamento' , $portadigitals->departamento)}}">
  </div>
  ...
  <div class="form-group col-md-6">
    <label for="barrio">Barrio</label>
       ...
       placeholder="barrio"
       name="Barrio"
       value="{{ old('barrio' , $portadigitals->barrio)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="direccion">Direccion</label>
       ...
       name="Direccion"
       value="{{ old('direccion' , $portadigitals->direccion)}}">
  </div>
  <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
    <label for="tipocliente">Tipo cliente</label>
       ...
       name="tipocliente"
       value="{{ old('tipocliente' , $portadigitals->tipocliente)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="planadquiere">Plan adquiere</label>
       ...
       name="planadquiere"
       value="{{ old('planadquiere' , $portadigitals->planadquiere)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="ncontacto">Numero de contacto</label>
       ...
       name="ncontacto"
       value="{{ old('ncontacto' , $portadigitals->ncontacto)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="imei">Imei</label>
       ...
       placeholder="Imei"
       name="imei"
       value="{{ old('imei' , $portadigitals->imei)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="ngrabacion">Numero de grabacion</label>
       ...
       name="ngrabacion"
       value="{{ old('ngrabacion' , $portadigitals->ngrabacion)}}">
  </div>
  <div class="form-group col-md-3">
    <label for="fvc">FVC</label>
       ...
       placeholder="fvc"
       name="fvc"
       value="{{ old('fvc' , $portadigitals->fvc)}}">
  </div>
  <div class="form-group col-md-3">
    <label for="fentrega">Fecha de entrega</label>
       ...
       name="fentrega"
       value="{{ old('fentrega' , $portadigitals->fentrega)}}">
  </div>
  <div class="form-group col-md-3">
    <label for="fexpedicion">Fecha de expedicion</label>
       ...
       name="fexpedicion"
       value="{{ old('fexpedicion' , $portadigitals->fexpedicion)}}">
  </div>
  <div class="form-group col-md-3">
    <label for="fnacimiento">Fecha de nacimiento</label>
       ...
       name="fnacimiento"
       value="{{ old('fnacimiento' , $portadigitals->fnacimiento)}}">
  </div>
  <div class="form-group col-md-6">
    <label for="origen">Origen de la migracion</label>
       ...
       placeholder="Origen"
       name="origen"
       value="{{ old('origen' , $portadigitals->origen)}}">
  </div>
  ...
  <div class="form-group col-md-6">
    <label for="orden">Numero de Orden</label>
       ...
       name="orden"
       value="{{ old('orden' , $portadigitals->orden)}}">
  </div>
...
<a href="{{route('portadigital.index')}}" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">VOLVER</a>
