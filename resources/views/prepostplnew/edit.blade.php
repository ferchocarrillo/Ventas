...
<form name="f1" action="{{ url('/prepostplnew/'.$prepostPLN->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
    @csrf
    @method('PATCH')
   ...
   <div class="form-group col-md-6">
        ...
        name="planes"
        value="{{ old('planes', $prepostPLN->planes)}}">
   </div>
...
<a href="{{route('prepostplnew.index')}}" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">VOLVER</a>
