    ...
    <div class="pull-right">
        <div class="col-md-12">
            ...
            <center style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                ...
                <h3 aline="center">NUEVO PLAN PORTABILIDAD</h3>
            </center>
                <form action="{{ url('/portaplnew')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                {{csrf_field()}}
                <div class="form-row">
                ...
                <input type="text" id ="nuevo" name="nuevo" class="form-control" placeholder="plan nuevo" required>
                  ...
                  <a href="{{route('portaplnew.index')}}" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">VOLVER</a>
               </div>
            </form>
            ...
            <script>
            Swal.fire(
              'PLAN NUEVO PORTABILIDAD',
              'Aqui registraras los nuevos planes de portabilidad',
              'success'
            )
            </script>
            @stop
