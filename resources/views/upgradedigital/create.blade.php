    ...
    <div class="pull-right">
        <div class="col-md-12">
            ...
            <center style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                ...
                <h3 aline="center">UP GRADE DIGITAL</h3>
            </center>
                    <form action="{{ url('/upgradedigital')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        {{csrf_field()}}
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <a href=({{ url('/welcome')}})><button type="reset"  class="btn btn-danger btn-sm">
