        ...
        <div class="col-md-12">
            ...
            <center style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                ...
                <h3 aline="center">PRE POST DIGITAL</h3>
                    ...
                    <form action="{{ url('/prepostdigital')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        {{csrf_field()}}
                        <div class="form-row">
                        ...
                        <div class="card-footer">
                            ...
                            <a href=({{ url('prepostdigital.create')}})><button type="reset"  class="btn btn-danger btn-sm">
