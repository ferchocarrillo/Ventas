    ...
    <div class="pull-right">
        <div class="col-md-12">
            <div class="card" style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
                ...
                <div class="col-md-4">
                <form action="/searchdigitalfija" method="GET">
                <div class="input-group">
        <input type="searchdigitalfija" name="searchdigitalfija" class="form-control">
...
@foreach ($fijas as $fija)
     <tr>
        ...
        <td>
            <form action="{{url('/fijadigital/'.$fija->id)}}" method="post">
                @csrf
                @method('DELETE')
        <a href="{{url('/fijadigital/'.$fija->id.'/edit')}}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Editar</a>
...
{{ $fijas->links() }}
        ...
        <p>
        clic <a href="{{route('fijaDigital.excel')}}">Aqui</a>
